        ...
        <div className="space-y-4 md:space-y-6 animate-fade-in pb-24 font-sans text-slate-800">
            ...
            {!selectedSection ? (
                ...
                <div className="bg-white rounded-3xl border-2 border-dashed border-slate-200 text-slate-400 text-center py-16">
                    ...
                    <p className="text-sm mt-1">يمكنك السحب من المخزون فقط. تفاصيل الحسابات متاحة للأدمن فقط.</p>
                    <button onClick={() => { setSelectedSection(null); }} className="mt-4 bg-slate-100 hover:bg-slate-200 text-slate-600 px-6 py-2.5 rounded-xl font-bold text-sm transition-all">
